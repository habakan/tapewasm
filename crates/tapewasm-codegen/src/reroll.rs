//! Finding the loops a vectorised statement leaves on the tape.
//!
//! Recording `y ~ normal(alpha + beta * x, sigma)` over N points writes the
...
mod tests {
    use super::*;
    use crate::shapes::{gather as gather_tape, linreg as linreg_tape};
