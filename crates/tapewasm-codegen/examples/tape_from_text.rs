...
//!
//!   cargo run -p tapewasm-codegen --example tape_from_text -- <file>
//!
...
fn run(
    ...
    unary!("acos", f64::acos);
    unary!("atan", f64::atan);
    unary!("lgamma", tapewasm_autodiff::lgamma);
    unary!("digamma", tapewasm_autodiff::digamma);
    unary!("phi", tapewasm_autodiff::phi_cdf);
    let pow = Func::wrap(
        &mut store,
